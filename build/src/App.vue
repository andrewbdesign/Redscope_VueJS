    ...
    <div id="app">
        <div class="preloader-screen" v-if="!imagesLoaded">
          ...
          <polygon fill="#DB1E26" points="165.426,97.215 157.425,89.216 157.425,127.808
          		...
          		<!-- outline -->
          <svg id="loader-logo-outline" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          	 width="592.495px" height="180.939px" viewBox="0 0 592.495 180.939" enable-background="new 0 0 592.495 180.939"
          	 xml:space="preserve">
          ...
          <g id="P-redscope">
          	<path class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" d="M458.46,22.175v67.973l13.398-2.366V66.797l20.595-4.022
          		c0,0,9.13-1.119,13.485-8.69c0,0,4.401-7.334,0.919-15.869c0,0-3.229-8.992-17.168-7.306l-14.732,2.293l8.234,8.234l5.576-0.811
          		c0,0,5.068-0.722,7.213,2.374c0,0,3.742,6.279-4.577,9.125l-19.545,3.218V31.661l16.706-2.603c0,0,6.627-1.336,12.803,1.268
          		c0,0,9.817,3.143,8.663,17.061c0,0-0.372,10.154-10.742,15.328c0,0-2.887,1.546-7.004,2.131l-17.39,3.397l8.303,8.303l12.041-2.137
          		c0,0,11.577-2.072,18.878-10.358c0,0,8.291-7.933,7.619-22.933c0,0,0.396-13.772-10.732-20.198c0,0-7.525-5.574-21.639-4.094
          		L458.46,22.175z"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="473.858,34.931 481.96,43.033 481.96,51.673 473.858,52.992
          			"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="473.858,70.035 481.858,78.035 481.858,96.207
          		473.858,88.207 	"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="472.519,89.696 459.525,91.991 467.799,100.264
          		480.794,97.97 	"/>
          </g>
          <g id="E-redscope-2">
          	<path class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" d="M555.001,37.555"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="544.995,21.835 553.995,29.198 553.995,33.674
          		544.995,35.166 	"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="546.335,20.346 555.273,27.66 590.431,21.456
          		583.152,14.179 	"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="584.495,1.82 584.495,12.693 591.495,19.693 591.495,8.82
          		"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="579.995,32.516 586.995,39.515 586.995,49.388
          		579.995,42.388 	"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="585.931,51.305 555.273,56.562 546.337,49.251
          		578.652,43.873 	"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="584.651,59.691 590.918,65.958 555.995,71.964
          		555.995,64.411 	"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="591.995,67.802 591.995,78.48 544.995,86.605
          		544.995,50.737 553.995,58.101 553.995,74.337 	"/>
          	<polygon class="ww" fill="none" stroke="#FFFFFF" stroke-miterlimit="10" points="542.995,85.407 542.995,47.78 577.995,41.955
          		577.995,31.721 542.995,37.525 542.995,18.878 582.495,12.261 582.495,0.594 530.694,9.566 530.694,73.309 	"/>
          </g>
          </svg>
        ...
        <div class="website" v-if="imagesLoaded">
...
export default {
    ...
    mounted: function() {
        ...
        var preloaderTimeline = new TimelineMax({
        	onComplete: function() {
                ...
                if(imagesFinished) {
                    ...
                    TweenMax.to('#loader-logo-outline', 1, {alpha:0, ease:Power1.easeOut, onComplete:function(){
						finishIntro()
					}}, '0')
                } else {
        ...
        var i = [
            // Letters
            'static/img/letters/letter-a-bg.jpg',
            'static/img/letters/letter-c-bg.jpg',
            'static/img/letters/letter-r-bg.jpg',
            'static/img/letters/letter-a-icon.png',
            'static/img/letters/letter-c-icon.png',
            'static/img/letters/letter-r-icon.png',

            // Showreel
            'static/img/showreel/01-boxer-man.png',
            'static/img/showreel/02-swimmer-girl-01.png',
            'static/img/showreel/02-swimmer-girl-02.png',
            'static/img/showreel/03-food-dudes.png',
            'static/img/showreel/04-fashion-chick.png',
            'static/img/showreel/05-phone-dude-01.png',
            'static/img/showreel/05-phone-dude-02.png',
            'static/img/showreel/06-hype-shoes-01.png',
            'static/img/showreel/06-hype-shoes-02.png',
            'static/img/showreel/showreel-play-btn.png',
            // 'static/img/showreel/01-boxer-man-bg.jpg',
            // 'static/img/showreel/02-swimmer-bg.jpg',
            // 'static/img/showreel/03-food-dudes-bg.jpg',
            // 'static/img/showreel/04-fashion-bg.jpg',
            // 'static/img/showreel/05-phone-dude-bg.jpg',
            // 'static/img/showreel/06-hype-shoes-bg.jpg',

            // Statics - Bio
            'static/img/bio/Adam.jpg',
            'static/img/bio/Benji.jpg',
            'static/img/bio/Em.jpg',
            'static/img/bio/Marvin.jpg',
            'static/img/bio/Noel.jpg',
            'static/img/bio/Rolando.jpg',
            'static/img/bio/Vienna.jpg',
            // Statics - Works
            'static/img/works/Adidashypeparty-1.jpg',
            'static/img/works/Fitnessplanet-1.jpg',
            'static/img/works/Hype_Girl-1.jpg',
